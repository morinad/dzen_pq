# Кастомный коннектор к Dzen для Power BI
...
1) Скачайте файл MEZ: https://github.com/morinad/dzen_pq/raw/main/Dzen.mez
...
4) Нажмите на кнопку "Получить данные", в поиске введите "Dzen" и выберите коннектор Dzen Connector.


### Полезные ссылки:
Подробная инструкция по использованию коннектора: http://directprobi.ru/blogs/statyi-yandex-dzen-v-excel-i-power-bi-query-integraciya-api/
